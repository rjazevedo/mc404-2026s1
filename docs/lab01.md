...
!!! tip "Dica"
    Assembly é uma linguagem de baixo nível, ou seja, ela é mais próxima do código de máquina que o processador executa. Por isso, ela é mais difícil de escrever e ler do que linguagens de alto nível como C ou Python. Dessa forma, cada programa precisa ser totalmente explícito sobre o que ele faz.
